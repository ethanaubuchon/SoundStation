...
// Shifts a song up in the queue by one 
exports.moveUpInQueue = function(position, callback) {
  
  if(queue[position] !== null && position > 0) {
...
// Shifts a song down in the queue by one 
exports.moveDownInQueue = function(position, callback) {
  var dest = parseInt(position)+1;
  if(queue[position] !== null && queue[dest] !== null && dest < queue.length) {
