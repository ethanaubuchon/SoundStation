...
// Try to end the current speaker
endSpeaker = function() {
...
// getCurrentSong, getQueue, getSongs, hasCurrent and isPlaying are used in 
// updateSong(), for the client to subscribe to their values
...
exports.playNow = function(id, callback) {
  endSpeaker();
  setTimeout(exports.playSong(id, callback), 10);
  // TODO: Get rid of the following line - have playing value update properly
  setTimeout(function(){playing = true; callback();}, 500);
};
