...
exports.queueSong = function(id, sessionID, callback) {
  exports.getSongById(id, function(song) {
    if (song !== null) {
      if (getSongPosition(song) > -1) {
        exports.voteForSongInQueue(song['id'], sessionID, callback);
      } else {
        song['votes'] = 1;
